...
def new_token():
    ...
    try:
        ...
        obj = {
            ...
            "beta": generate_confirmation_token(generate_confirmation_token(tenant_id)).replace("trovato-", "")[:32],
...
def token_list():
    ...
    try:
        ...
        for o in objs:
            if not o["beta"]:
                o["beta"] = generate_confirmation_token(generate_confirmation_token(tenants[0].tenant_id)).replace("trovato-", "")[:32]
